...
\begin{frame}{Hardware - Der Plan \textsuperscript{TM}}
	...
	\begin{itemize}
		...
		\end{itemize}
	\end{itemize}
	Bauteilkosten: ca. \EUR{3} pro Board zzgl. \EUR{8} pro tatsächlich genutztem Kanal
\end{frame}


\begin{frame}{Hardware - Erster Entwurf}
	\includegraphics[width=0.8\textwidth]{AudioBoardSchema.pdf}
	\includegraphics[width=0.48\textwidth]{AudioBoard.pdf}
\end{frame}
